...
<p align="center">
  ...
  <i>The most comprehensive MCP server for Adobe InDesign. 192 tools. 32 handlers. Full DOM coverage.</i>
</p>
...
<p align="center">
  ...
  <a href="#"><img src="https://img.shields.io/badge/tools-192-7c3aed?style=flat" alt="tools"></a>
...
| **Tool count** | **192** | Unlimited (you write them) | 5-20 typical | 5-20 typical | ∞ (manual) |
...
| **Maintenance** | Zero (we handle 192 tools) | You write+test everything | Fragile | Fragile | N/A |
...
| `mcp://tools/inventory` | Full 192-tool catalog for agent self-discovery |
