...
export class AnchoredObjectHandler implements IHandler {
  ...
  private async create(args: unknown, _extra: any): Promise<ToolResult> {
    ...
    const code = `
      ...
      var newItem;
      // NOTE: InDesign 2026's move() no longer accepts an InsertionPoint target
      // ("Invalid value for parameter 'to'... Expected Array of 2 Units, Spread,
      // Page or Layer"). Adding the item to the insertion point's own
      // collection anchors it inline — the supported way.
